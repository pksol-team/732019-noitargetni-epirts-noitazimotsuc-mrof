<div style="padding: 20px;display:none;" id="tab_content_3" class="tab_content_form">
                ...
                <div class="col-xs-12 col-sm-9 col-md-8">
                    <div type="select" value="1" label="Choose your writer"
                        ...
                        @foreach($writer_categories as $writer_category)
                            <a onclick="setWriterCategory({{ $writer_category->id }});" href="#" id="writer_category_{{ $writer_category->id }}" class="writer-categories btn btn-default {{ $writer_category->id == $wtr_id ? 'active':'' }}" role="button"><span
        ...
        <div class="row">
            ...
            <div class="col-xs-8">
                <div class="nextBurtton">
                    <button onclick="return payLater();" class="btn pull-left btn-xs btn-info orderform-submit" {{ Auth::user() ? '':'disabled="true"' }} tabindex="0" type="submit">
                        <div>
                            <div style="">
                    ...
                    <button class="btn btn-primary pull-right orderform-submit" {{ Auth::user() ? '':'disabled="true"' }} tabindex="0" type="submit">
                        <div>
