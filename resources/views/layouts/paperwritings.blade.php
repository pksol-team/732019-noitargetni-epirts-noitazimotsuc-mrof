			...
			<table width="580" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth">
				...
				<tr>
					<td align="right" valign="middle" style="font-family: Helvetica, arial, sans-serif; font-size: 10px;color: #999999">
						<p>
							<a href="http://www.paperwritings.us/">paperwritings.us</a>
						</p>
					</td>
				</tr>
				<!-- Spacing -->
							...
							<tr>
								<td valign="middle" width="270" style="padding: 4px 0px 2px 10px;" class="logo">
									<div class="imgpop">
										...
										</div> <a href="http://www.paperwritings.us/"><img src="http://paperwritings.us/wp-content/uploads/2016/06/green2-768x120.png" width="100%" alt="logo" border="0" style="display:block; border:none; outline:none; text-decoration:none;" class="logo" /></a>
									</div>
								</td>
							</tr>
							</tbody>
		...
		<td width="100%">
			...
			<table width="580" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth">
				...
				<tr>
					<td align="center" valign="middle" style="font-family: Helvetica, arial, sans-serif; font-size: 10px;color: #999999">
						<p>
							<a href="http://www.paperwritings.us/">http://www.paperwritings.us/</a>
						</p>
						<p>
							Excellent Academic Paper Writing Services
						</p>
						<p>
							Email: info@paperwritings.us
						</p>
					</td>
				</tr>
				<!-- Spacing -->
