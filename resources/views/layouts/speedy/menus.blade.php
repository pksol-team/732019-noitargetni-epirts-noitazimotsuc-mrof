...
<div class=" col-md-2">
    <div class="left-main-menu">
        <div class="pre-main-menu">
            <a class="" style="text-decoration: none;" href="{{ url('stud/new') }}">
            ...
            <a class="" style="text-decoration: none;" href="{{ url('stud') }}">
            <div class="desktop-dashboard-menu" style="padding: 0px; display: block; user-select: none;">
            ...
            <a class="" style="text-decoration: none;" href="{{ url('departments/messages') }}">
            <div class="desktop-dashboard-menu" style="padding: 0px; display: block; user-select: none;">
                <div id="dashboard-menu" style="opacity: 1;">
                    <div>
                        <span class="order-dash" tabindex="0" type="button" style="">
            ...
            <a class="" style="text-decoration: none;" href="{{ url('user/profile') }}">
            <div class="desktop-dashboard-menu" style="padding: 0px; display: block; user-select: none;">
                <div id="dashboard-menu" style="opacity: 1;">
                    <div>
                        <span class="order-dash" tabindex="0" type="button" style="">
