...
echo $split[0];?>
            ...
            <option value="research-papers"<?php if($split[0]=='research-papers') echo "selected" ?>>research-papers</option>
                ...
                <option value="us"<?php if($split[0]=='us') echo "selected" ?>>us</option>
                    ...
                    <div class="col-md-8">
                        <input type="text" required="" value="{{$posts[0]->page_name}}" name="" class="form-control" autocomplete="off" readonly>
                    </div>
                </div>
...
echo $split[count($split)-1];?>" name="page_name" class="form-control" autocomplete="off">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <input type="text" required="" value="{{$posts[0]->title}}" name="title" class="form-control" autocomplete="off">
                    </div>
                </div>
                 <div class="form-group">
                    <label class="control-label col-md-3">Description</label>
                    <div class="col-md-8">
                        <input type="text" required="" value="{{$posts[0]->description}}" name="description" class="form-control" autocomplete="off">
                    </div>
                </div>
                  <div class="form-group">
                    <label class="control-label col-md-3">Main Heading</label>
                    <div class="col-md-8">
                        <input type="text" required="" value="{{$posts[0]->main_heading}}" name="main_heading" class="form-control" autocomplete="off">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <textarea name="main_content" cols="15" rows="10" class="form-control">{{$posts[0]->main_content}}</textarea>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <textarea name="second_content" cols="15" rows="10" class="form-control">{{$posts[0]->second_content}}</textarea>
                    </div>
                </div>
                    <div class="form-group">
                     <label class="control-label col-md-3"></label>
