            ...
            <table id="rates_table" class="table table-bordered table-striped">
                ...
                <?php foreach($features as $feature): ?>
                    ...
                    <tr class="tabular">
                        ...
                        <td><?php echo e($feature->inc_type == 'percent' ? $feature->amount.'%':'$'.$feature->amount); ?></td>
                        <td>
                            <a class="btn btn-info btn-xs" data-toggle="modal" href="#feature_modal" onclick="editFeature(<?php echo e($feature); ?>)"><i class="fa fa-edit"></i> Edit</a>
                            <a class="btn btn-danger btn-xs" onclick="return confirm('Are you sure?');" href="<?php echo e(URL::to("additional-features/delete/$feature->id")); ?>"><i class="fa fa-delete"></i> Delete</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </table>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-horizontal ajax-post" method="post" action="<?php echo e(URL::to('additional-features')); ?>">
