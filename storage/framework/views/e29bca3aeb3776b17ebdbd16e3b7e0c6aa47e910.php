<?php $__env->startSection('content'); ?>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <?php /*<div style="margin: 0px !important;" class="col-md-3 pull-right row">*/ ?>
                <?php /*<img style="pading: 0px;margin: 0px;" src="http://www.homeworkmake.com/wp-content/uploads/2016/07/banner-6.png">*/ ?>
            <?php /*</div>*/ ?>
            <div style="margin: 0px !important;" class="col-md-13">
                <form method="post" action="<?php echo e(URL::to('/stud/new')); ?>" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            ...
                            <?php foreach($academic_levels as $academic_level): ?>
                                <input onclick="setAcademic(<?php echo e($academic_level->id); ?>)" type="radio" id="radio<?php echo e($academic_level->id); ?>" name="academic_id" value="<?php echo e($academic_level->id); ?>" <?php echo e(@$get_data['academic_id'] ? @$get_data['academic_id']==$academic_level->id ? "checked":"" :$no==0 ? "checked":""); ?>>
                                <label for="radio<?php echo e($academic_level->id); ?>"><?php echo e($academic_level->level); ?></label>
                                <?php $no++; ?>
                            <?php endforeach; ?>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <input onchange="getOrderCost();" type="number" required min="1" value="<?php echo e(@$get_data['pages'] ? @$get_data['pages']:"1"); ?>" class="form-control" name="pages">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            ...
                            <?php foreach($writer_categories as $writer_category): ?>
                                <input onclick="getOrderCost()" type="radio" id="radio_wtr<?php echo e($writer_category->id); ?>" name="writer_category_id" value="<?php echo e($writer_category->id); ?>" <?php echo e($no==0 ? "checked":""); ?>>
                                <label for="radio_wtr<?php echo e($writer_category->id); ?>"><?php echo e($writer_category->name); ?></label>
                                <?php $no++; ?>
                            <?php endforeach; ?>
                        </div>
                    </div>
                    ...
                    <input type="hidden" name="partial" value="<?php echo e(@$get_data['partial']); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <a class="btn btn-warning" href="<?php echo e(URL::to('/order')); ?>"><i class="fa fa-times"></i> Cancel</a>&nbsp;
...
*/
    ...
    <script type="text/javascript">
        ...
        var rate = null;
        var initial_rate = '<?php echo e(@$get_data['rate_id']); ?>';
