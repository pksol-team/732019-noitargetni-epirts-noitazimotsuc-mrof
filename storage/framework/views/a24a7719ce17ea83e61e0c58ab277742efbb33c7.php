...
<?php $__env->startSection('title','My Account | Register Page'); ?>
    ...
    <div class="container">
        <div class="row">
			  ...
			  <div class="col-sm-7 col-md-8 col-xs-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="<?php echo e(URL::to('user/register')); ?>">
                            <?php echo csrf_field(); ?>

                          <input type="hidden" name="role" value="<?php echo e($website->role); ?>">
			...
			<div class="col-sm-5 col-md-4 col-xs-12 features-links">
			    <ul>
			       <li><a href="https://www.essayprint.com/assignment">Assignment</a></li>
			       <li><a href="https://www.essayprint.com/essay-writer">Essay Writer</a></li>
			       <li><a href="https://www.essayprint.com/case-study">Case Study</a></li>
			       <li><a href="https://www.essayprint.com/dissertation">Dissertation</a></li>
			       <li><a href="https://www.essayprint.com/homework">Homework</a></li>
			       <li><a href="https://www.essayprint.com/coursework">Course Work</a></li>
			       <li><a href="https://www.essayprint.com/research">Research</a></li>
			       <li><a href="https://www.essayprint.com/thesis">Thesis</a></li>
			 </ul>
			</div>
        </div>
        </div>
