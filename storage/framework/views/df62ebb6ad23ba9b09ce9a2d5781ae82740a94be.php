										...
										<div class="row">
											<div class="col-xs-12 contents">
											   <ul>
											    ...
											    <li><img src="<?php echo e(URL::asset('front/images/mastercard.jpg')); ?>" alt="card"></li>
											    <li><img src="<?php echo e(URL::asset('front/images/paypal.jpg')); ?>" alt="card"></li>
											    <li><img src="<?php echo e(URL::asset('front/images/amex.jpg')); ?>" alt="card"></li>
											    <li><img src="https://d13yqfbidbuu4k.cloudfront.net/dwfnvjkfnqF31pc/visa.jpg" alt="card"></li>
											    <li><img src="https://d13yqfbidbuu4k.cloudfront.net/dwfnvjkfnqF31pc/visa.jpg" alt="card"></li>
											   </ul>
											</div>
