...
//		console.log(rates);
	...
	function countWords(){
		var spacing = jQuery("select[name='spacing']").val();
		var pages = jQuery("input[name='pages']").val();
        var partial = '<?php echo e(@$_GET['partial']); ?>';
...
//            console.log(found);
	...
	function getOrderCost(){
        ...
        var deposit_rate = parseFloat('<?php echo e(@$website->deposit/100); ?>');
	...
	function checkId(){
        ...
        var data = {id:id};
        $.get('<?php echo e(URL::to("order/check-number")); ?>',data,function(response){
            if(response == 0){
