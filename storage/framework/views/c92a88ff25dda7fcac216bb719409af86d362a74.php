...
<script type="text/javascript">
    ...
    function showLoading(){
        $(".alert_status").remove();
        $('.modal-body').prepend('<div id="" class="alert alert-success alert_status"><img style="" class="loading_img" src="<?php echo e(URL::to("img/ajax-loader.gif")); ?>"></div>');
    }
...
$(window).ready(function(){
    ...
    function showRequest(formData, jqForm, options) {
        $(".alert_status").remove();
        $('.file-form').prepend('<div id="" class="alert alert-success alert_status"><img style="" class="loading_img" src="<?php echo e(URL::to("img/ajax-loader.gif")); ?>"></div>');
    }
