        ...
        <div class="row">
			...
			<div class="col-xs-12 col-sm-8">
                ...
                <div class="nextBurtton">
                    ...
                    <button class="btn btn-primary pull-right orderform-submit" <?php echo e(Auth::user() ? '':'disabled="true"'); ?> tabindex="0" type="submit" style="width:100%">
                        <div>
					      ...
					      <button onclick="return payLater();" class="btn pull-left btn-xs btn-info orderform-submit" <?php echo e(Auth::user() ? '':'disabled="true"'); ?> tabindex="0" type="submit" style="width:100%;margin-top:10px;height:32px">
                        <div>
                            <div style="">
