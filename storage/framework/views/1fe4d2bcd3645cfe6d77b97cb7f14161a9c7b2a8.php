...
<?php $__env->startSection('content'); ?>
    <div class="panel panel-default">
        <div class="panel-heading"><?php echo e(ucwords($role)); ?>s</div>
            ...
            <form method="GET" action="<?php echo e(URL::to('emails/send')); ?>">
                ...
                <?php foreach($users as $writer): ?>
                    ...
                    <tr class="tabular">
                        ...
                        <td>
                            <?php echo e($active = count($writer->orders()->where([
            ['paid','=',1],
            ['status','!=',2],
            ['status','!=',4]
        ])->get())); ?>
                        ...
                        <td>
                            <?php echo e($revision = count($writer->orders()->where([
            ['paid','=',1],
            ['status','=',4]
        ])->orderBy('id','desc')->get())); ?>
                        ...
                        <td>
                            <?php echo e($pending = count($writer->orders()->where([
            ['paid','=',1],
            ['status','=',3]
        ])->orderBy('id','desc')->get())); ?>
                        ...
                        <td>
                            <?php echo e($completed = count($writer->orders()->where([
            ['status','=',4]
        ])->orderBy('id','desc')->get())); ?>

                        </td>
                        <td>
                            <a href="<?php echo e(URL::to("user/view/$role/$writer->id")); ?>" class="btn btn-info btn-xs">View</a>
                    ...
                    <div class="well gridular well-lg col-md-11">
                        <div class="row">
                            ...
                            <?php if(Auth::user()->isAllowedTo('view_email')): ?>
                                <div class="col-sm-4"><strong>E-mail: </strong><?php echo e($writer->email); ?></div>
                            <?php endif; ?>
