...
<div id="o_order" class="tab-pane fade in active">
    <h3>Order Details</h3>
    <?php /*<?php echo e(dd($order)); ?>*/ ?>
    <div id="actions" style="">
    <a href="<?php echo e(URL::to("user/view/client".'/'.$order->user->id)); ?>" class="btn btn-info"><i class="fa fa-user"></i> View Client</a>
          <a onclick=" $('#cost_form').slideToggle();" class="btn btn-default" href="#"><i class="fa fa-edit"></i> Change Cost</a>
        <?php if($user->isAllowedTo('change_order_client')): ?> <a onclick="" class="btn btn-primary" href="#change_user_modal" data-toggle="modal"><i class="fa fa-user"></i> Change Client</a> <?php endif; ?>
    <?php if($user->isAllowedTo('mark_order_paid')): ?> <a class="btn btn-success" data-toggle="modal" href="#mark_order_paid"><i class="fa fa-check"></i> Mark Paid</a> <?php endif; ?>
        <?php if(@$order->status <=2): ?>
            <?php if($user->isAllowedTo('force_assign_writer_job')): ?> <a class="btn btn-success" href="#assign_modal" data-toggle="modal"><i class="fa fa-arrows-h"></i> Assign Job</a> <?php endif; ?>

        <?php endif; ?>
    </div>
    <div id="cost_form" class="col-md-5" style="display: none;">
        <form action="<?php echo e(URL::to("order/changecost")); ?>" class="form-horizontal alert alert-success" method="post">
            ...
            <div class="form-group">
                ...
                <div class="col-md-5">
                    <input type="text" class="form-control" value="<?php echo e($order->amount); ?>" name="amount">
        ...
        <table align="centre" class="table table-bordered">
                ...
                <td>
                    ...
                    <strong style="font-weight: bold;">
                        ...
                        <?php if($order->paid): ?>
                            ...
                            <?php if($order->payments()->sum('amount')<$order->amount): ?>
                                <span style="color:red;"><i class="fa fa-times"></i> Pending(<?php echo e(@number_format($order->amount-$order->payments()->sum('amount'),2)); ?>)</span>
                            <?php endif; ?>
                        <?php endif; ?>
                    </strong>
                        <?php endif; ?>
            ...
            <tr>
                ...
                <td>
                    ...
                    <?php if(isset($writer)): ?>
                        <?php echo e(@$writer->id.'#'.@$wrier->name.'('.@$writer->email.')'); ?>
...
<?php if(Auth::user()->isAllowedTo('edit_order_details')): ?>
            <tr>
                <td colspan="4">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" method="post" action="<?php echo e(URL::to("order/force_assign")); ?>">
...
<div id="change_user_modal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" method="post" action="<?php echo e(URL::to("order/change/user/$order->id")); ?>">
                    <input type="hidden" name="id" value="<?php echo e($order->id); ?>">
...
<script type="text/javascript">
    ...
    $(function() {
        var ms = $(".client_id").magicSuggest({
            data: '<?php echo e(URL::to('user/clients/list')); ?>',
            valueField: 'id',
            method:'get',
            displayField: 'email',
            required:true,
...
<div id="add_pages_modal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" method="post" action="<?php echo e(URL::to("order/add_pages/$order->id")); ?>">
                    <?php echo e(csrf_field()); ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php
                    ...
                    ?>
                <form class="form-horizontal ajax-post" method="post" action="<?php echo e(URL::to("order/quote/$order->id")); ?>">
                    <?php echo e(csrf_field()); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input id="total_price" type="text" value="<?php echo e($amount); ?>" class="form-control" name="amount">
                        </div>
                    </div>
                    <div class="form-group">
...
<div id="add_instructions_modal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" method="post" action="<?php echo e(URL::to("order/add_instructions/$order->id")); ?>">
                    <?php echo e(csrf_field()); ?>
...
<div class="modal fade" role="dialog" id="add_sources_modal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" method="post" action="<?php echo e(URL::to("order/add_sources/$order->id")); ?>">
                    <?php echo e(csrf_field()); ?>
...
<div id="add_hours_modal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" method="post" action="<?php echo e(URL::to("order/add_hours/$order->id")); ?>">
                    <?php echo e(csrf_field()); ?>
...
<div id="mark_order_paid" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal ajax-post" method="post" action="<?php echo e(URL::to("order/$order->id/markpaid")); ?>">
                    <?php echo e(csrf_field()); ?>

                    <div class="form-group">
                        <label class="control-label col-md-3">Amount</label>
                        <div class="col-md-6">
                            <input required type="text" value="<?php echo e(round($order->amount,2)); ?>" class="form-control" name="amount">
                        </div>
                    </div>
                    <div class="form-group">
