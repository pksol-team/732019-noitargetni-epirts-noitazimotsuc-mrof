<?php $get_data = $_GET; ?>
<div style="padding: 0px;display:none;" id="tab_content_2" class="tab_content_form">
    <h1 style="margin-bottom: 45px;margin-top: 0 !important;">Price Calculation</h1>
        ...
        <div class="row form-group">
            ...
            <div class="col-xs-12 col-sm-3 col-md-4"><span class="input-group"><span class="input-group-btn"><button
                                name="minus" onclick="minusPages()" type="button" class="btn btn-default">−</button></span><input name="pages" type="number"
                                                                                                           value="<?php echo e(@$_GET['pages'] > 0 ? $_GET['pages']:1); ?>"
                                                                                                           label="Pages"
        ...
        <div class="form-group  row" style="text-transform: uppercase;">
            ...
            <div class="col-xs-12 col-sm-9 col-md-8">
                <div type="select" value="118" label="Spacing" class="ButtonGroup btn-group btn-group-justified">
                    <a onclick="return selectSingle();"  href="#" class="btn btn-default single-spacing" role="button">single</a>
                    <a onclick="return selectDouble();" value="118" href="#" class="btn btn-default active double-spacing" role="button">double</a>
