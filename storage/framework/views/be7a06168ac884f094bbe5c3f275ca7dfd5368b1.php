                ...
                <table class="table table-bordered table-condensed">
                    ...
                    <?php foreach($order->files as $file): ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <a download="<?php echo e($file->filename); ?>" target="_blank" href="<?php echo e(URL::to('/order/download/').'/'.$file->id); ?>"><img height="20px;" src="<?php echo e($image); ?>"><?php echo e($file->filename); ?></a>
                            </td>
                            <td><?php echo e($file->file_for); ?></td>
                            <td><?php echo e(@number_format(@$file->filesize/1024,2)); ?> KB</td>
                        </tr>
                    <?php endforeach; ?>
                    <?php foreach(\App\File::whereIn('assign_id',$assign_ids)->whereNotIn('id',$taken_files)->where([
                        ['allow_client','=',1]
                    ])->get() as $file): ?>
                        <?php
                        $image = @$images[$file->file_type];
