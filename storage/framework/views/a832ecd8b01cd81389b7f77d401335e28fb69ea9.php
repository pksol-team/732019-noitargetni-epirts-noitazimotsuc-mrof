                    ...
                    <div class="panel-body">
                        <table style="font-size: large;font-family: sans-serif, Verdana;" class="table table-">
                            ...
                            <tr>
                                ...
                                <td>$<?php echo e(number_format($user->totalWorked(),2)); ?></td>
                            </tr>
                            <tr>
                                ...
                                <td>$<?php echo e(number_format($withdrawn,2)); ?></td>
                            </tr>
                                <tr>
                                    ...
                                    <td>$<?php echo e(number_format($fines,2)); ?></td>
                                </tr>
                            <tr>
                                ...
                                <td>$<?php echo e(number_format($pending,2)); ?></td>
                            </tr>
                            <tr>
                                ...
                                <td>$<?php echo e(number_format($available,2)); ?>

                                    <?php if(Auth::user()->id == $user->id): ?>
                                        <?php if(env('MINIMUM_WITHDRAW',20)>$available): ?>
                                            <a onclick="showInfo('Minimum allowed to withdraw is <?php echo e(number_format(env('MINIMUM_WITHDRAW',20),2)); ?>')" class="badge alert-info" href="#" data-toggle="modal"><i class="fa fa-question"></i> </a>
                                        <?php else: ?>
                                            <?php
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <table class="table table-condensed">
                            ...
                            <?php foreach($user->paymentAccounts as $account): ?>
                                <?php $saved_websites[]=$account->website;  ?>
                                <tr>
                                    <td><?php echo e($no); ?></td>
                                    <td><?php echo e($account->website); ?></td>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <table class="table table-condesed">
                            ...
                            <?php
                            $no = 1;
                                $payouts  = $user->payments()->orderBy('id','desc')->paginate(10);
                            ?>
                            <?php foreach($payouts as $payout): ?>
                                <tr>
                                    <td><?php echo e($no++); ?></td>
                                    <td><?php echo e($payout->transaction_reference); ?></td>
                                    <td><?php echo e($payout->amount); ?></td>
                                    <td><?php echo e($payout->state); ?></td>
                                    <td><?php echo e(ucwords($payout->method)); ?></td>
                                    <td><?php echo e(date('Y M d, H:i',strtotime($payout->created_at))); ?></td>
                                </tr>
                            <?php endforeach; ?>
                        </table>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <form class="form-horizontal" action="<?php echo e(URL::to("writer/add_payment")); ?>" method="post">
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                    ...
                                    <select name="website" required class="form-control">
                                        <?php foreach($allowed_websites as $website): ?>
                                            <?php if(!in_array($website,$saved_websites)): ?>
                                                <option value="<?php echo e($website); ?>"><?php echo e(ucwords($website)); ?></option>
                                            <?php endif; ?>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
    ...
    <div class="modal fade" role="dialog" id="withdrawal_modal">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-horizontal" method="post" action="<?php echo e(URL::to("writer/withdraw")); ?>">
                        <?php echo e(csrf_field()); ?>

                        <div class="form-group">
                            <label class="control-label col-md-3">AMOUNT(USD)</label>
                            <div class="col-md-5">
                                <input name="amount" type="text" class="form-control" disabled value="<?php echo e(number_format($available,2)); ?>">
                            </div>
                        </div>
                        <div class="form-group">
    ...
    <style type="text/css">
        ...
        .skrill{background-image:url(<?php echo e(URL::to('img/skrill_all.png')); ?>);}
        .paypal{background-image:url(<?php echo e(URL::to('img/paypal_all.png')); ?>);}
