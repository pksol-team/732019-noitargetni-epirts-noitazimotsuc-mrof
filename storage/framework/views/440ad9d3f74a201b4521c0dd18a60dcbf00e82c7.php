    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal ajax-post" action="<?php echo e(URL::to('stud/redeem-bonus')); ?>">
                    <?php echo e(csrf_field()); ?>

                    <div class="form-group">
                        <label class="control-label col-md-4">Points</label>
                        <div class="col-md-5">
                            <input type="number" max="<?php echo e($user->getPoints()); ?>" value="<?php echo e($user->getPoints()); ?>" name="points" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <div class="modal-body">
                ...
                <ol>
                    <li><strong>By Order payments</strong><p>
                            For each <strong>$<?php echo e(number_format($www->getPointPay(),2)); ?></strong> you pay for an order, you earn <strong>+<?php echo e(1); ?></strong> more point(s)
                        </p>
                    </li>
                    <li><strong>By Referrals</strong><p>
                            For each student you refer and places an order you get <strong>+<?php echo e(round($www->getReferralPoints(),0)); ?></strong> more point(s)
                        </p>
                    </li>
                </ol>
            </div>
...
<div class="modal fade" role="dialog" id="top_up_modal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form onsubmit="return validateForm();" class="form-horizontal" method="post" action="<?php echo e(URL::to("stud/top-up")); ?>">
                    <div class="form-group amt">
                        ...
                        <div class="col-md-6">
                            ...
                            <input onkeyup="validateForm();" type="text" value="<?php echo e(@$order->amount ? round($order->amount,2):100); ?>" class="form-control" name="amount">
...
<script type="text/javascript">
    ...
    function setRedeemAmount(){
        var rate = '<?php echo e($user->website->getRedeemRate()); ?>';
