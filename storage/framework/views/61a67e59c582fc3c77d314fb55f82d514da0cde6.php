<?php $__env->startSection('content'); ?>
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <?php echo $__env->make('user.acc_payments', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            <h3>Order History</h3>
            <div class="row"></div>
            <table class="table">
                <thead>
                ...
                <?php foreach($assigns as $assign): ?>
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-success btn-xs" href="<?php echo e(URL::to("/order/$assign->order_id/room/$assign->id")); ?>"><i class="fa fa-users fa-fw"></i>Room</a>
