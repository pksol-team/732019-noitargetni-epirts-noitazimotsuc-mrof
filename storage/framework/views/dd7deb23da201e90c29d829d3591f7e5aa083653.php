                            ...
                            <tr>
                                ...
                                <td>$<?php echo e(number_format($available,2)); ?>
                                    ...
                                    <?php if(Auth::user()->id == $user->id): ?>
                                        <?php if($available<1): ?>
                                            <a onclick="showInfo('Minimum allowed to withdraw is <?php echo e(number_format(1,2)); ?>')" class="badge alert-info" href="#" data-toggle="modal"><i class="fa fa-question"></i> </a>
                                        <?php else: ?>
                                            <?php
                        ...
                        <table class="table table-condensed">
                            ...
                            <?php foreach($user->paymentAccounts as $account): ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php /*<a class="btn btn-success btn-xs" href=""><i class="fa fa-edit"></i></a>*/ ?>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </table>
