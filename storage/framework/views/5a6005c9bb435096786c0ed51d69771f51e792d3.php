        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body" >           
                ...
                <div id="div1" class="row" style="max-height: 400px; overflow-y: scroll">
                    <div class="chat">
                        <?php foreach($order->messages()->orderBy('id','desc')->get() as $message): ?>
                            <?php if($message->sender==0): ?>
                                <hr>
                                <div class="bubble me"><?php echo $message->message ?>
                                    <br/>
                                    <strong style="color:blue;">To:<i><?php echo e(ucwords($message->destination ? $message->destination:'Support')); ?></i></strong>
                                    <br/><small><strong><?php echo e($message->created_at); ?></strong></small>
                                </div>
                            <?php else: ?>
                                <hr>
                                <div class="bubble you"><?php echo $message->message ?>
                                    <br/>
                                    <strong style="color:blue;">From: <i><?php echo e(ucwords($message->destination ? $message->destination:'Support')); ?></i></strong>
                                    <br/>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="messageform" class="ajax-post form-horizontal" method="post" action="<?php echo e(URL::to("messages/ordermessages/$order->id")); ?>" class="form-horizontal">
