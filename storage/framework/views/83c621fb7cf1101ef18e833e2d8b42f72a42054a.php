    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <div class="panel-title">
                Enable Order <a href=""><?php echo e($bidmapper->order->topic); ?></a> For Bidding
            </div>
        </div>
        <div class="panel-body">
           <div class="col-md-6 col-md-offset-2">
               ...
               <form class="form-horizontal" method="post" action="<?php echo e(URL::to("order/activate/$bidmapper->id")); ?>">
                   ...
                   <div class="form-group">
                       ...
                       <div class="col-md-4">
                           <?php foreach($writer_categories as $writer_category): ?>
                            <input type="checkbox" name="writer_categories[]" value="<?php echo e($writer_category->id); ?>" <?php echo e(@in_array($writer_category->id,json_decode($bidmapper->allowed)) ? "checked":""); ?>><?php echo e($writer_category->name); ?><br/>
                           <?php endforeach; ?>
                       </div>
                   </div>
                   <div class="form-group">
