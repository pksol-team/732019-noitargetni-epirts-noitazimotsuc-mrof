    ...
    function showRatingGauge(){
        $(function () {
            ...
            $('#rating_gauge').highcharts({
                        ...
                        series: [{
                            name: 'Rating',
                            data: [<?php echo e($user->getRating()); ?>],
                            tooltip: {
                                valueSuffix: ' Stars'
                            }
                        }]
    ...
    function showOrderStats(){
        $(function () {
            $('#order_stats').highcharts({
                ...
                series: [{
                    name: 'Orders',
                    data: [<?php echo e($user->active()); ?>, <?php echo e($user->revision()); ?>, <?php echo e($user->pending()); ?>,<?php echo e($user->cancelled()); ?>,<?php echo e($user->completed()); ?>]
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <select name="writer_category_id" class="form-control">
                                <?php foreach(\App\WriterCategory::where('deleted','=',0)->get()as $category): ?>
