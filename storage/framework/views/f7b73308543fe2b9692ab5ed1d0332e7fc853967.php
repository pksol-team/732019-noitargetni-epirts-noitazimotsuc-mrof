    ...
    <fieldset id="fieldset_s3" class="orderform-step clearfix">
        ...
        <?php else: ?>
            ...
            <div class="alert alert-info" id="box_defined_writer">
                ...
                <p>
                    The copy of your completed paper will be sent to you, after which the remaining <strong><?php echo e(100-$website->deposit); ?>%</strong> will be paid.
                </p>
            </div>
        ...
        <div class="ui-tabs ui-widget ui-widget-content ui-corner-all"
            ...
            <div aria-hidden="false" aria-expanded="true" role="tabpanel"
                ...
                <input type="hidden" name="user_id" value="<?php echo e(@Auth::user()->id or ''); ?>">
                <div id="box_fname" class="row">
                    <div class="cell cell-left">
                ...
                <input type="hidden" name="referred_by" value="<?php echo e(@$_GET['referred_by']); ?>">
                  <div id="box_fname" class="row">
                    <div class="cell cell-left">
                  ...
                  <em class="forIE"><em class="forIE2">
                          <input onclick="return loginUser();" aria-disabled="false" role="button"
                            ...
                            <div class="input-model"><a target="_blank" 
                                        href="<?php echo e(URL::to('forgot/password')); ?>"
       ...
       <div id="box_payment_system" class="row box_payment_system_logged ui-buttonset">
            ...
            <div aria-describedby="qtip-32" data-hasqtip="32" class="cell cell-right side_tip side_tip_payment_system">
                <div class="visible-in-mobile">
                    <select name="payment_method" class="form-control">
                        ...
                        <?php /*<option value="payza">Payza</option>*/ ?>
                ...
                <div class="visible-in-desktop">
                    ...
                    <label style="height:65px;padding-top: 10px;font-weight:500;font-size: medium;" id="payment_label_paypal" onclick="setPaymentMethod('paypal');" for="academic_input_56" data-hasqtip="0"
                        ...
                        <strong><img style="max-width:105px;padding-top:-5px;" src="<?php echo e(URL::to("img/paypal.jpg")); ?>"></strong>
                    </label>
                    <?php /*<input id="payment_method_payza" type="radio" title="asd" value=""*/ ?>
                           <?php /*name="academiclevel" class="ui-helper-hidden-accessible"*/ ?>
                           <?php /*checked="checked">*/ ?>
                    <?php /*<label style="height:65px;padding-top: 10px;font-weight:500;font-size: medium;" id="payment_label_payza" onclick="setPaymentMethod('payza');" for="academic_input_56" data-hasqtip="0"*/ ?>
                           <?php /*class="payment_lbl ui-button ui-widget ui-button-text-only"*/ ?>
                           <?php /*role="button" aria-disabled="false" aria-pressed="true">*/ ?>
                        <?php /*<strong><img style="max-width:105px;padding-top:-5px;" src="<?php echo e(URL::to("img/payza.jpg")); ?>"></strong>*/ ?>
                    <?php /*</label>*/ ?>
        ...
        <input onclick="return payNow();" <?php echo e(Auth::user() ? '':'disabled'); ?> class="orderform-submit button highlight large to_billing_btn proceed_checkoutt"
        ...
        <div id="box_payment_system" class="row box_payment_system_logged ui-buttonset">
            <div class="orderform-buttons f_submit_box f_submit_box_logged">
                <input style="height: 25px; padding:2px !important;" onclick="return payLater();" <?php echo e(Auth::user() ? '':'disabled'); ?> class="orderform-submit btn-sm btn-link button highlight large to_billing_btn"
                       value="Pay Later"
                       type="submit">
    ...
    function registerUser(){
        ...
        $.post(url,data,function(response){
            ...
            if(result.id==undefined){
              ...
              console.log(data);
             var url = '<?php echo e(URL::to('user/login')); ?>';
                 $.post(url,data ,function(response){
...
<style type="text/css">
    form-box-pay #ps_ingenico_btn:after {
        ...
        margin: 0 5px;
        height: 16px;
        background: transparent <?php echo e(URL::to('/img/cabinet_spr.png')); ?> 999px 999px no-repeat !important;
        content: " ";
        text-indent: 0;
    }
</style>