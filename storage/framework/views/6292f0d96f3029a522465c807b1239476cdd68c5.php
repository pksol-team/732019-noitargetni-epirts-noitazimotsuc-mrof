...
<div class="container-fluid header">
 ...
 <nav class="navbar navbar-inverse">
    <div class="container-fluid">
      ...
      <a class="navbar-brand" href="<?=url("/");?>"><img src="<?php echo e(URL::asset('front/images/logo.png')); ?>" class="logo" alt="logo"></a>
    </div>
	<div class="row">
      <div class="collapse navbar-collapse" id="myNavbar">
       ...
       <img class="navbar-toggle cross" data-toggle="collapse" data-target="#myNavbar" src="<?php echo e(URL::asset('front/images/close.svg')); ?>" alt="X">
     </div>
     </div>
    </div>
  </nav>
