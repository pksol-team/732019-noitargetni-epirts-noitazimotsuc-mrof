                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="<?php echo e(URL::to('user/register')); ?>">
                          ...
                          <input type="hidden" name="role" value="<?php echo e($website->role); ?>">
                            ...
                            <div class="form-group<?php echo e($errors->has('robot') ? ' has-error' : ''); ?>">
                                <div class="col-md-6 col-md-offset-4">
                                    <div class="g-recaptcha" data-sitekey="6Ldx5zAUAAAAALAV4i8fyompAguYs5_nYuAHohOh"></div>                                    <?php if($errors->has('robot')): ?>
                                        <span class="help-block">
                                        <strong><?php echo e($errors->first('robot')); ?></strong>
                                    </span>
                                    <?php endif; ?>
                                </div>
                            </div>
