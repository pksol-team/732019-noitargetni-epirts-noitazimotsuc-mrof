            ...
            <table class="table table-bordered table-condensed">
                ...
                <?php foreach($order->messages()->orderBy('id','desc')->get() as $message): ?>
                    <tr>
                        ...
                        <td>
                            <?php echo e(ucwords($message->user->role)); ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="messageform" method="post" action="<?php echo e(URL::to("messages/ordermessages/$order->id")); ?>" class="form-horizontal ajax-post">
