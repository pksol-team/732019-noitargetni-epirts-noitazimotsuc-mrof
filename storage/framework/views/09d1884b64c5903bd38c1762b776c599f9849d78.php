        ...
        <div class="panel-body">
            <form method="post" action="" class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input type="number" required value="<?php echo e((int)$language->amount); ?>" name="amount" class="form-control">
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-md-3">Label</label>
                    <div class="col-md-4">
                        <input type="text" required value="<?php echo e($language->label); ?>" name="label" class="form-control">
                    </div>
                </div>
                <div class="form-group">
